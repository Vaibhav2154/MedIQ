...
async def interpret_consent(request: InterpretationRequest):
    ...
    try:
        ...
        print(f"  - Allowed data: {interpreted.allowed_data_categories}")
        print(f"  - Allowed purposes: {interpreted.allowed_purposes}")
        print(f"  - Denied data: {interpreted.denied_data_categories}")
        print(f"  - Denied purposes: {interpreted.denied_purposes}")
